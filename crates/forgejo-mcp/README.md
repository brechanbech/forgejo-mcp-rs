...
> time-boxed **write mode**. See [`SPECIFICATION.md`](https://codeberg.org/brechanbech/forgejo-mcp-rs/src/branch/main/SPECIFICATION.md) for the full design.

It speaks the Forgejo REST API directly through a small, in-house client (`src/forge/`, over the
shared [`forgejo-mcp-core`](https://codeberg.org/brechanbech/forgejo-mcp-rs/src/branch/main/crates/mcp-core)
transport) — an
...
`confirm` argument equal to `"owner/repo"`. See [`SPECIFICATION.md`](https://codeberg.org/brechanbech/forgejo-mcp-rs/src/branch/main/SPECIFICATION.md#write-mode-deliberate-time-boxed-elevation)
for the full design.
...
[specification](https://codeberg.org/brechanbech/forgejo-mcp-rs/src/branch/main/SPECIFICATION.md).
...
See [`SPECIFICATION.md`](https://codeberg.org/brechanbech/forgejo-mcp-rs/src/branch/main/SPECIFICATION.md#security-model).
...
CI runs the same on [Codeberg Forgejo Actions](https://codeberg.org/brechanbech/forgejo-mcp-rs/src/branch/main/.forgejo/workflows/ci.yml); a tracked
[`.githooks/pre-push`](https://codeberg.org/brechanbech/forgejo-mcp-rs/src/branch/main/.githooks/pre-push) hook mirrors it locally
...
MIT — see [LICENSE.md](https://codeberg.org/brechanbech/forgejo-mcp-rs/src/branch/main/LICENSE.md) for details.
